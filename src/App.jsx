...
import Desklympics from "./pages/Desklympics";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<GameLayout />}>
            ...
            <Route path="/games/desklympics" element={<Desklympics />} />
            <Route path="/games/prop-improv" element={<Navigate to="/games/desklympics" replace />} />
